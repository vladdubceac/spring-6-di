...
public class LifeCycleDemoBean implements  InitializingBean, DisposableBean, BeanNameAware,
    ...
    public void setBeanFactory(BeanFactory beanFactory) throws BeansException {
        System.out.println("## 3 BeanFactoryAware, Bean Factory has been set : " + beanFactory);
    }

    @Override
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        System.out.println("## 4 ApplicationContext has been set : " + applicationContext);
    }
    ...
    public void afterPropertiesSet() throws Exception {
        System.out.println("## 6 afterPropertiesSet, the populate properties the LifeCycleBean has its properties");
    }

    @PreDestroy
    public void preDestroy(){
        System.out.println("## 7 preDestroy, the preDestroy method has been called ...");
    }
